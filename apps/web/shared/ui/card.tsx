...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "rounded-[28px] border border-border/70 bg-card/92 text-card-foreground shadow-[0_30px_80px_-42px_color-mix(in_oklab,var(--primary)_32%,black)] backdrop-blur-sm",
        className,
      )}
      {...props}
    />
